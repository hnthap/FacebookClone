namespace FacebookCloneWinForms
{
	partial class SignUpForm
	{
		...
		private void InitializeComponent()
		{
			...
			SignUpContentPanel.Controls.Add(BirthDateDateTimePicker);
			SignUpContentPanel.Controls.Add(LastNameTextBox);
			SignUpContentPanel.Controls.Add(FirstNameTextBox);
			...
			// FirstNameTextBox
			// 
			FirstNameTextBox.Font = new Font("Trebuchet MS", 16.2F, FontStyle.Regular, GraphicsUnit.Point);
			FirstNameTextBox.ForeColor = SystemColors.ControlDark;
			FirstNameTextBox.Location = new Point(27, 97);
			FirstNameTextBox.Multiline = true;
			FirstNameTextBox.Name = "FirstNameTextBox";
			FirstNameTextBox.Size = new Size(206, 70);
			FirstNameTextBox.TabIndex = 4;
			FirstNameTextBox.Text = "First name...";
			FirstNameTextBox.TextChanged += UserNameTextBox_TextChanged;
			// 
			// RePasswordTextBox
			// 
			...
			// LastNameTextBox
			// 
			LastNameTextBox.Font = new Font("Trebuchet MS", 16.2F, FontStyle.Regular, GraphicsUnit.Point);
			LastNameTextBox.ForeColor = SystemColors.ControlDark;
			LastNameTextBox.Location = new Point(239, 97);
			LastNameTextBox.Multiline = true;
			LastNameTextBox.Name = "LastNameTextBox";
			LastNameTextBox.Size = new Size(211, 70);
			LastNameTextBox.TabIndex = 6;
			LastNameTextBox.Text = "Last name...";
			// 
			// BirthDateDateTimePicker
			// 
			BirthDateDateTimePicker.Font = new Font("Segoe UI", 16.2F, FontStyle.Regular, GraphicsUnit.Point);
			BirthDateDateTimePicker.Location = new Point(27, 173);
			BirthDateDateTimePicker.Name = "BirthDateDateTimePicker";
			BirthDateDateTimePicker.Size = new Size(423, 43);
			BirthDateDateTimePicker.TabIndex = 7;
			// 
			// SignUpForm
			// 
